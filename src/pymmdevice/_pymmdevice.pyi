...
class PyCoreCallback(Core):
    def AcqFinished(self, caller: Device, statusCode: int) -> int: ...
    def ClearImageBuffer(self, caller: Device) -> None: ...
    def ClearPostedErrors(self) -> None: ...
    def GetChannelConfig(
        self, channelConfigName: str, channelConfigIterator: int
    ) -> int: ...
    def GetClockTicksUs(self, caller: Device) -> int: ...
    def GetCurrentConfig(self, group: str, bufLen: int, name: str) -> int: ...
    def GetDevice(self, caller: Device, label: str) -> Device: ...
    def GetDeviceProperty(self, deviceName: str, propName: str, value: str) -> int: ...
    def GetExposure(self, expMs: float) -> int: ...
    def GetFocusPosition(self, pos: float) -> int: ...
    def GetImage(self) -> str: ...
    def GetImageDimensions(self, width: int, height: int, depth: int) -> int: ...
    def GetSerialAnswer(
        self, device: Device, portName: str, ansLength: int, answerTxt: str, term: str
    ) -> int: ...
    def GetXYPosition(self, x: float, y: float) -> int: ...
    def InitializeImageBuffer(
        self, channels: int, slices: int, w: int, h: int, pixDepth: int
    ) -> bool: ...
    def LogMessage(self, caller: Device, msg: str, debugOnly: bool) -> int: ...
    def MoveFocus(self, v: float) -> int: ...
    def MoveXYStage(self, vX: float, vY: float) -> int: ...
    def NextPostedError(
        self, errorCode: int, pMessage: str, maxlen: int, messageLength: int
    ) -> None: ...
    @typing.overload
    def OnExposureChanged(self, arg0: Device, arg1: float) -> int: ...
    @typing.overload
    def OnExposureChanged(self, device: Device, newExposure: float) -> int: ...
    def OnMagnifierChanged(self, device: Device) -> int: ...
    def OnPropertiesChanged(self, caller: Device) -> int: ...
    def OnPropertyChanged(self, device: Device, propName: str, value: str) -> int: ...
    def OnSLMExposureChanged(self, device: Device, newExposure: float) -> int: ...
    def OnStagePositionChanged(self, device: Device, pos: float) -> int: ...
    def OnXYStagePositionChanged(
        self, device: Device, xpos: float, ypos: float
    ) -> int: ...
    def PostError(self, errorCode: int, pMessage: str) -> None: ...
    def PrepareForAcq(self, caller: Device) -> int: ...
    def PurgeSerial(self, caller: Device, portName: str) -> int: ...
    def ReadFromSerial(
        self, caller: Device, portName: str, buf: int, bufLength: int, bytesRead: int
    ) -> int: ...
    def SetConfig(self, group: str, name: str) -> int: ...
    def SetDeviceProperty(self, deviceName: str, propName: str, value: str) -> int: ...
    def SetExposure(self, expMs: float) -> int: ...
    def SetFocusPosition(self, pos: float) -> int: ...
    def SetSerialCommand(
        self, device: Device, portName: str, command: str, term: str
    ) -> int: ...
    ...
    def SetXYPosition(self, x: float, y: float) -> int: ...
    def Sleep(self, caller: Device, intervalMs: float) -> None: ...
    def WriteToSerial(
        self, caller: Device, portName: str, buf: int, length: int
    ) -> int: ...
    def __init__(self) -> None: ...
